...
public class PermissionsActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if(android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.M){
            ...
            throw new RuntimeException("当前设备非6.0以上设备无需使用动态权限设定!");

        }else if (getIntent() == null || !getIntent().hasExtra(EXTRA_PERMISSIONS)) {
    ...
    protected void onResume() {
        ...
        if (isRequireCheck) {
            if (PermissionsChecker.lacksPermissions(this)) {
                requestPermissions(PermissionsChecker.getPermission()); // 请求权限
            } else {
